...
export const event_1_title = "Farmers’ training in agroforestry and natural farming";
export const event_1_location = "Chirantana School, Kabbalu, Kanakapura";
export const event_1_description = "Farmers’ training in agroforestry and natural farming is organized on May 2022 in Chirantana School, Kabbalu, Kanakapura to spread awareness among farmers.";
